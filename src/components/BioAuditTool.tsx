                ...
                {loadingState === LoadingState.ERROR ? (
                    ...
                    <div className="bg-white border border-zinc-200 rounded-xl divide-y divide-zinc-200 shadow-sm">
                        ...
                        <div className={cn(
                            ...
                            <StatCard label="Conversion Rate" value={checklist.customDomain ? "+45%" : "0%"} sub="More Actions Taken" icon={TrendingUp} loading={loadingState === LoadingState.LOADING} />
                            <StatCard label="Search Traffic" value={checklist.seo ? "3.5x" : "1x"} sub="Indexed by AI" icon={Users} loading={loadingState === LoadingState.LOADING} />
                            <StatCard label="Brand Equity" value={checklist.customDomain ? "+100%" : "0%"} sub="Owned Asset Value" icon={BarChart3} loading={loadingState === LoadingState.LOADING} />
                            <StatCard label="Engagement" value={checklist.speed ? "+6.4k" : "0"} sub="Monthly Impressions" icon={Wallet} loading={loadingState === LoadingState.LOADING} />
                        </div>
