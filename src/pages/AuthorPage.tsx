...
const AuthorPage = () => {
    ...
    return (
        <div className="bg-white min-h-screen font-sans">
            ...
            {/* Author Hero */}
            <Section variant="default" className="pt-32 pb-20 border-b border-zinc-200 relative overflow-hidden">
            ...
            {/* Author's Posts */}
            <Section variant="grid" className="py-20 min-h-[50vh]">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {authorPosts.map((post, i) => (
                            <FadeIn key={post.id} delay={0.05 + (i * 0.05)}>
                                <Link to={`/post/${post.slug}`} className="group flex flex-col h-full bg-white border border-zinc-200 rounded-[4px] overflow-hidden hover:border-zinc-400 transition-colors shadow-sm hover:shadow-md">
